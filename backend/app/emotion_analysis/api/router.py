...
from ...schemas import ApiResponse, EmotionAnalyzeResponse, EmotionRequest
...
@router.post(
    ...
    summary="Analyze emotion (JSON or multipart)",
    description=(
...
async def emotion_analyze(request: Request, db: Session = Depends(get_db)):
    """
